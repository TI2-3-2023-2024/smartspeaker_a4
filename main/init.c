...
const char *AUDIO_PIPELINE = "AUDIO_PIPELINE";
...
{
    ESP_LOGW(AUDIO_PIPELINE, "[ 2 ] Start codec chip for both");
...
{
    ESP_LOGW(AUDIO_PIPELINE, "[4.0] Create audio pipeline for playback");
